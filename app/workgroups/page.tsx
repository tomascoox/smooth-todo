...
export default function WorkgroupsPage() {
  ...
  useEffect(() => {
    fetchWorkgroups();
    const interval = setInterval(fetchWorkgroups, 5000); // Refresh every 5 seconds
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <form onSubmit={handleCreateWorkgroup} className="flex gap-2">
            <Input
              type="text"
        ...
        {workgroups.map((workgroup) => (
          <Card key={workgroup._id}>
            ...
            <CardContent>
              ...
              <Link href={`/app/workgroups/${workgroup._id}`} passHref>
                <Button className="mt-2">View Workgroup</Button>
              </Link>
            </CardContent>
          </Card>
        ))}
